...
export const RegistrationPage: FC = () => {
  return (
    <div className='relative flex h-[100svh] w-full items-center justify-center bg-background overflow-hidden'>
      ...
      <div className='flex shadow-registration flex-col rounded-3xl bg-background-secondary justify-center items-center gap-2 pt-2 z-10 max-sm:w-full max-sm:h-full max-sm:rounded-none'>
        <div className='text-5xl text-text font-medium max-2xl:text-4xl max-sm:text-3xl'>
          FePo
        </div>
        <div className='flex shadow-registration-additional flex-col rounded-3xl bg-gradient-to-b from-background-primary-linear-first to-background-primary-linear-second items-center gap-5 p-5 max-sm:gap-3 max-sm:p-3 max-sm:shadow-registration-sm'>
